...
// GET students/:id 
app.get('/students/:id/:age', async (req,res)=>{
    const connection = await dbConn
    const rows = await connection.query('SELECT * from students where id = ' +req.params.id+' or age =' + req.params.age)
    res.send(rows)
})
...
// ทำ POST ข้อมูลใหม่ /students สำหรับข้อมูล student 1 คน
// JSON Body-Parser 
/*
{
    "name":"Oak",
...
// PUT เป็นการแก้ไข ต้องมีข้อมูลอยู่แล้ว
/*
{
    "name":"Oak",
    "age":"22",
